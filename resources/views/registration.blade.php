...
<div class="main-area">
    ...
    <section class="right-section full-height" style="width: 70%;">
                    ...
                    <div class="inner">
                        <div class="form-content" >
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-holder">
                                    <input type="text" placeholder="Área de Actuação/Actividade"
                                           class="form-control" name="area_operation" required>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-holder">
                                    <input type="number" placeholder="Nuit" id="nuit"
                                           class="form-control" name="nuit" required>
                                </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-holder">
                                    <select class="form-control" name="action_time_market" required>
                    ...
                    <div class="inner">
                        ...
                        <div class="form-content">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-holder">
                                    <input name="r_email" type="email" placeholder="E-mail"
                                           class="form-control">
                                </div>
