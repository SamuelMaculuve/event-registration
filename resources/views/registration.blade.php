            ...
            <!-- SECTION 1 -->
                ...
                <section>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-4">
                            <input name="c_contact_nuit" type="number" placeholder="Nuit" maxlength="9" title="Por valor, coloque um valor valido"
                                   class="form-control form-control-lg form-control-solid">
                        </div>
                    </div>
                ...
                <section>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            <input name="r_cell" type="number" placeholder="Cell" maxlength="9" title="Por valor, coloque um valor valido"
                                   class="form-control form-control-lg form-control-solid">
                        </div>
                        <div class="form-group col-sm-6">
